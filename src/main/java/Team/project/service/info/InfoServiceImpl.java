...
public class InfoServiceImpl implements InfoService{
    ...
    public InfoDto studentUpdate(Long id, InfoDto infoDto) {
        ...
        infoDto.setId(student.getId());
        infoDto.setHakbun(student.getHakbun());
        infoDto.setName(student.getName());
        infoDto.setPassword(student.getPassword());
        infoDto.setMajor(student.getMajor().getName());
        infoDto.setCity(student.getAddress().getCity());
        infoDto.setStreet(student.getAddress().getStreet());
        infoDto.setYears(student.getSemesterInfo().getYears());
        infoDto.setSemester(student.getSemesterInfo().getSemester());
        infoDto.setStatus(student.getStatus().name());
        return infoDto;
    }
    ...
    public InfoDto professorUpdate(Long id, InfoDto infoDto) {
        ...
        infoDto.setId(professor.getId());
        infoDto.setHakbun(professor.getLoginId());
        infoDto.setName(professor.getName());
        infoDto.setPassword(professor.getPassword());
        infoDto.setMajor(professor.getMajor().getName());
